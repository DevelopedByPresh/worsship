...
import Base5 from "./Base5.png"
import Base7 from "./Base7.png"
import Base8 from "./Base8.png"
import Base9 from "./Base9.png"
import Base10 from "./Base10.png"

// ==============================|| AUTHENTICATION - CARD WRAPPER ||============================== //

export default function Step3Card({ children, ...other }) {
      ...
      <Stack sx={{ display: { xs:'none', sm: 'none', md: 'none', lg: 'block' },  }}  >
        ...
        <Stack style={{position:'absolute', top:25, left:30, flexDirection:'row', gap:10, alignItems:'center'}}>
          ...
          <Stack style={{position:'absolute', top:230, left:30, flexDirection:'row', gap:10, alignItems:'center'}}>
                <img src={Base5} alt=""  style={{height:50, width:350}}/>
        </Stack>

          <Stack style={{position:'absolute', top:290, left:30, flexDirection:'row', gap:10, alignItems:'center'}}>
                      <img src={Base7} alt=""  style={{height:50, width:350}}/>
        </Stack>

          <Stack style={{position:'absolute', top:350, left:30, flexDirection:'row', gap:10, alignItems:'center'}}>
                <img src={Base9} alt=""  style={{height:50, width:350}}/>
        </Stack>



        
          <Stack style={{position:'absolute', top:410, left:30, flexDirection:'row', gap:10, alignItems:'center'}}>
                <img src={Base10} alt=""  style={{height:50, width:350}}/>
        </Stack>
      </Stack>
...
Step3Card.propTypes = { children: PropTypes.any, other: PropTypes.any };
