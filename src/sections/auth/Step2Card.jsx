...
import Base6 from "./Base6.png"

// ==============================|| AUTHENTICATION - CARD WRAPPER ||============================== //

export default function Step2Card({ children, ...other }) {
    ...
    >
      ...
      <Stack sx={{ display: { xs:'none', sm: 'none', md: 'none', lg: 'block' },  }}  >
        ...
        <Stack style={{position:'absolute', top:25, left:30, flexDirection:'row', gap:10, alignItems:'center'}}>
          ...
          <Stack style={{position:'absolute', top:290, left:28, flexDirection:'row', gap:10, alignItems:'center'}}>
                      <img src={Base6} alt=""  style={{height:50, width:350}}/>
        </Stack>
...
Step2Card.propTypes = { children: PropTypes.any, other: PropTypes.any };
