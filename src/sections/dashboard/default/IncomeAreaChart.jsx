...
export default function IncomeAreaChart({ view }) {
  ...
  return (
    <>
    <Stack style={{flexDirection:'row', justifyContent:'space-between', padding:'10px 20px'}}>

      <Stack  style={{flexDirection:'row', gap:20, alignItems:'center'}}>
      <Typography variant='h3' color='black'>Live Stream Engagement</Typography>
